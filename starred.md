...
| 分类 | 子分类 | 项目数 |
|------|--------|--------|
| DevOps & 工具 | 效率工具(10), CI/CD(6) | 16 |
| Web 开发 | 前端(8), 后端(1) | 9 |
| AI | 自然语言处理(4), 机器学习(3) | 7 |
| 脚本 / 自动化 | 脚本 / 自动化(5) | 5 |
| 学习资料 | 学习资料(2) | 2 |
| 其他 | 其他(45) | 45 |
...
- ⭐ 3846 · 🍴 299 · 📅 2025-11-28
- 📦 最新版本：[v1.1.2](https://github.com/scriptscat/scriptcat/releases/tag/v1.1.2)（2025-09-18）
...
- ⭐ 982 · 🍴 41 · 📅 2025-11-28
- 📦 最新版本：[v1.7.11](https://github.com/MCDFsteve/NipaPlay-Reload/releases/tag/v1.7.11)（2025-11-25）
...
- ⭐ 5385 · 🍴 173 · 📅 2025-11-28
- 📦 最新版本：[v1.6.0](https://github.com/venera-app/venera/releases/tag/v1.6.0)（2025-11-01）
